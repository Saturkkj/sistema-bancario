...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            print("\n--- Opração falhou! Você não tem saldo suficiente ---")
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if excedeu_limite:
            ...
            print("\n--- Operação falhou! Número máximo de saqus excedido. ---")
...
def criar_cliente(clientes):
    ...
    endereco = input("Informe o endereço (logradouro, Nº - bairro - cidade/silga estado): ")
...
def criar_conta(numero_conta, clientes, conta):
    ...
    if not cliente:
        print("-n--- Cliente não encontrado, fluxo d criação de conta encerrado! ---")
        return
...
def listar_contas(contas):
    for conta in contas:
        print("=" * 100)
        print(textwrap.decent(str(conta)))
...
def main():
    ...
    while True:
         ...
         if opcao == "2":
             ...
             print("\n--- Operação inválida, por favor selecione novamente a operação desjada. ---")
